...
class Group(models.Model):
    ...
    user1ID = models.CharField(max_length=50, default="", blank=True, verbose_name='user1 아이디')
    user2ID = models.CharField(max_length=50, default="", blank=True, verbose_name='user2 아이디')
    user3ID = models.CharField(max_length=50, default="", blank=True, verbose_name='user3 아이디')
    user4ID = models.CharField(max_length=50, default="", blank=True, verbose_name='user4 아이디')
